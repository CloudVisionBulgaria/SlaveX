...
*/
SlaveXAudioProcessor::SlaveXAudioProcessor()
...
#endif
{
	...
	NormalisableRange<float> volumeRange(-48, 0.0);
...
//Returns the name.
//==============================================================================
const String SlaveXAudioProcessor::getName() const
{
	return JucePlugin_Name;
}

//The effect plugin doesn't accept midi signals because it doesn't need it.
bool SlaveXAudioProcessor::acceptsMidi() const
{
...
bool SlaveXAudioProcessor::producesMidi() const
{
...
bool SlaveXAudioProcessor::isMidiEffect() const
{
#if JucePlugin_IsMidiEffect
	return true;
#else
...
double SlaveXAudioProcessor::getTailLengthSeconds() const
{
	return 0.0;
}

//Returns the number of programs.
int SlaveXAudioProcessor::getNumPrograms()
{
...
int SlaveXAudioProcessor::getCurrentProgram()
{
	return 0;
}

//This is the method for hosts to change the number of running plugins.
void SlaveXAudioProcessor::setCurrentProgram(int index)
{
}

//Returns the program name.
const String SlaveXAudioProcessor::getProgramName(int index)
{
	return {};
}

//Changes the program name.
void SlaveXAudioProcessor::changeProgramName(int index, const String& newName)
{
}

// This method is for pre-playback initialization.
//==============================================================================
void SlaveXAudioProcessor::prepareToPlay(double sampleRate, int samplesPerBlock)
{
...
void SlaveXAudioProcessor::releaseResources()
{
...
#ifndef JucePlugin_PreferredChannelConfigurations
bool SlaveXAudioProcessor::isBusesLayoutSupported(const BusesLayout& layouts) const
{
#if JucePlugin_IsMidiEffect
...
void SlaveXAudioProcessor::processBlock(AudioBuffer<float>& buffer, MidiBuffer& midiMessages)
{
...
//==============================================================================
void SlaveXAudioProcessor::getStateInformation(MemoryBlock& destData)
{
...
void SlaveXAudioProcessor::setStateInformation(const void* data, int sizeInBytes)
{
